...
RESOURCES += src/qt/fantasy.qrc src/qt/fantasy_locale.qrc

TRANSLATIONS += src/qt/locale/fantasy_bg.ts \
                src/qt/locale/fantasy_de.ts \
                src/qt/locale/fantasy_en.ts \
                src/qt/locale/fantasy_es.ts \
                src/qt/locale/fantasy_fi.ts \
                src/qt/locale/fantasy_fr.ts \
                src/qt/locale/fantasy_it.ts \
                src/qt/locale/fantasy_ja.ts \
                src/qt/locale/fantasy_pl.ts \
                src/qt/locale/fantasy_pt.ts \
                src/qt/locale/fantasy_ru.ts \
                src/qt/locale/fantasy_sk.ts \
                src/qt/locale/fantasy_sv.ts \
                src/qt/locale/fantasy_vi.ts \
                src/qt/locale/fantasy_zh_CN.ts \
                src/qt/locale/fantasy_zh_TW.ts
