Contributing to Fantasy Core
==================================

The Fantasy Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fantasy Core project, and is not to be
confused with overall Fantasy Network Protocol consensus changes.

Whether a pull request is merged into Fantasy Core rests with the project merge
...
Patches that change Fantasy consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fantasy consensus, it must have been
...
The project leader is the release manager for each Fantasy Core release.
