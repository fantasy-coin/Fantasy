...
In order to support loading of multiple wallets in fantasy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fantasy.cpp.
...
Changes to fantasy.cpp
----------------------
fantasy.cpp is the entry point into fantasy-qt, and as such, will require some minor modifications to provide hooks for
