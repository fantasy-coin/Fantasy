...
Intro
-----
Fantasy (FAN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Fantasy utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run fantasy-qt.exe.

Fantasy Core is the original Fantasy client and it builds the backbone of the network.
However, it downloads and stores the entire history of Fantasy transactions;
