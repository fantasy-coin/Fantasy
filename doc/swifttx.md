...
This mechanism has been integrated into Bitcore-Node-Fantasy which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fantasy/insight-api-fantasy#web-socket-api](https://github.com/fantasy/insight-api-fantasy#web-socket-api)
* API: [https://github.com/fantasy/insight-api-fantasy#swifttx-transactions](https://github.com/fantasy/insight-api-fantasy#swifttx-transactions)
...
By default, the Fantasy Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fantasy Core daemon:
