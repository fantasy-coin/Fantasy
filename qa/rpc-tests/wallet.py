...
#   c) node1 mines 32 blocks, so now node 0 has 500000FAN, node 1 has 4250FAN, node2 has none.
#   d) node0 sends 601 FAN to node2, in two transactions (301 FAN, then 300 FAN).
