...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Fantasy server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fantasy features */
        {"fantasy", "masternode", &masternode, true, true, false},
        {"fantasy", "listmasternodes", &listmasternodes, true, true, false},
        {"fantasy", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fantasy", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fantasy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fantasy", "masternodedebug", &masternodedebug, true, true, false},
        {"fantasy", "startmasternode", &startmasternode, true, true, false},
        {"fantasy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fantasy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fantasy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fantasy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fantasy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fantasy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fantasy", "mnbudget", &mnbudget, true, true, false},
        {"fantasy", "preparebudget", &preparebudget, true, true, false},
        {"fantasy", "submitbudget", &submitbudget, true, true, false},
        {"fantasy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fantasy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fantasy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fantasy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fantasy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fantasy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fantasy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fantasy", "checkbudgets", &checkbudgets, true, true, false},
        {"fantasy", "mnsync", &mnsync, true, true, false},
        {"fantasy", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> fantasy-cli " + methodname + " " + args + "\n";
}
