...
/** Utility functions used by the Fantasy Qt UI.
 */
namespace GUIUtil
{
...
// Render FAN addresses in monospace font
...
// Parse "fantasy:" URI into recipient object, return true on successful parsing
